...
# Generate a tcl script for writing a binary to a memory location in the FPGA from Vivado.
# This requires the JTAG2AXIMaster Xilinx IP to be present inside the design
#
# Usage:
