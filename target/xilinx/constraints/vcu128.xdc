...
set_property IOSTANDARD DIFF_SSTL12 [get_ports "c0_sys_clk_p"]; # Bank  66 VCCO - DDR4_VDDQ_1V2 - IO_L11N_T1U_N8_GC_66
set_property PACKAGE_PIN BH51       [get_ports "c0_sys_clk_p"]; # Bank  66 VCCO - DDR4_VDDQ_1V2 - IO_L11N_T1U_N8_GC_66
set_property IOSTANDARD DIFF_SSTL12 [get_ports "c0_sys_clk_n"]; # Bank  66 VCCO - DDR4_VDDQ_1V2 - IO_L11N_T1U_N9_GC_66
set_property PACKAGE_PIN BJ51       [get_ports "c0_sys_clk_n"]; # Bank  66 VCCO - DDR4_VDDQ_1V2 - IO_L11N_T1U_N9_GC_66

set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets -of [get_ports "c0_sys_clk_p"]];
set_property CLOCK_BUFFER_TYPE NONE      [get_nets -of [get_ports "c0_sys_clk_p"]];
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets -of [get_ports "c0_sys_clk_n"]];
set_property CLOCK_BUFFER_TYPE NONE      [get_nets -of [get_ports "c0_sys_clk_n"]];
...
set_property CLOCK_BUFFER_TYPE NONE [get_nets cpu_resetn_IBUF_inst/O];

# safety island

#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets -of [get_ports jtag_safety_island_tck_i]];
#set_property CLOCK_BUFFER_TYPE NONE [get_nets -of [get_ports jtag_safety_island_tck_i]];
...
#set_property PACKAGE_PIN B25     [get_ports jtag_safety_island_tdo_o]; # B25 - H17 (FMCP_HSPC_LA11_N) - J1.08 - TDO
#set_property IOSTANDARD LVCMOS18 [get_ports jtag_safety_island_tdo_o]

#set_property PACKAGE_PIN B26     [get_ports jtag_safety_island_tck_i]; # B26 - H16 (FMCP_HSPC_LA11_P) - J1.06 - TCK
#set_property IOSTANDARD LVCMOS18 [get_ports jtag_safety_island_tck_i];
...
#set_property PACKAGE_PIN H22     [get_ports jtag_safety_island_tms_i]; # H22 - G16 (FMCP_HSPC_LA12_N) - J1.12 - TNS
#set_property IOSTANDARD LVCMOS18 [get_ports jtag_safety_island_tms_i];

#set_property PACKAGE_PIN J22     [get_ports jtag_safety_island_tdi_i]; # J22 - G15 (FMCP_HSPC_LA12_P) - J1.10 - TDI
#set_property IOSTANDARD LVCMOS18 [get_ports jtag_safety_island_tdi_i];
