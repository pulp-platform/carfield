...
package carfield_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    carfield_reg2hw_boot_mode_reg_t boot_mode; // [541:539]
    carfield_reg2hw_generic_scratch0_reg_t generic_scratch0; // [538:507]
    carfield_reg2hw_generic_scratch1_reg_t generic_scratch1; // [506:475]
    carfield_reg2hw_host_rst_reg_t host_rst; // [474:474]
    carfield_reg2hw_periph_rst_reg_t periph_rst; // [473:473]
    carfield_reg2hw_safety_island_rst_reg_t safety_island_rst; // [472:472]
    carfield_reg2hw_security_island_rst_reg_t security_island_rst; // [471:471]
    carfield_reg2hw_pulp_cluster_rst_reg_t pulp_cluster_rst; // [470:470]
    carfield_reg2hw_spatz_cluster_rst_reg_t spatz_cluster_rst; // [469:469]
    carfield_reg2hw_l2_rst_reg_t l2_rst; // [468:468]
    carfield_reg2hw_host_isolate_reg_t host_isolate; // [467:467]
    carfield_reg2hw_periph_isolate_reg_t periph_isolate; // [466:466]
    carfield_reg2hw_safety_island_isolate_reg_t safety_island_isolate; // [465:465]
    carfield_reg2hw_security_island_isolate_reg_t security_island_isolate; // [464:464]
    carfield_reg2hw_pulp_cluster_isolate_reg_t pulp_cluster_isolate; // [463:463]
    carfield_reg2hw_spatz_cluster_isolate_reg_t spatz_cluster_isolate; // [462:462]
    carfield_reg2hw_periph_clk_en_reg_t periph_clk_en; // [461:461]
    carfield_reg2hw_safety_island_clk_en_reg_t safety_island_clk_en; // [460:460]
    carfield_reg2hw_security_island_clk_en_reg_t security_island_clk_en; // [459:459]
    carfield_reg2hw_pulp_cluster_clk_en_reg_t pulp_cluster_clk_en; // [458:458]
    carfield_reg2hw_spatz_cluster_clk_en_reg_t spatz_cluster_clk_en; // [457:457]
    carfield_reg2hw_l2_clk_en_reg_t l2_clk_en; // [456:456]
    carfield_reg2hw_periph_clk_sel_reg_t periph_clk_sel; // [455:454]
    carfield_reg2hw_safety_island_clk_sel_reg_t safety_island_clk_sel; // [453:452]
    carfield_reg2hw_security_island_clk_sel_reg_t security_island_clk_sel; // [451:450]
    carfield_reg2hw_pulp_cluster_clk_sel_reg_t pulp_cluster_clk_sel; // [449:448]
    carfield_reg2hw_spatz_cluster_clk_sel_reg_t spatz_cluster_clk_sel; // [447:446]
    carfield_reg2hw_l2_clk_sel_reg_t l2_clk_sel; // [445:444]
    carfield_reg2hw_periph_clk_div_value_reg_t periph_clk_div_value; // [443:419]
    carfield_reg2hw_safety_island_clk_div_value_reg_t safety_island_clk_div_value; // [418:394]
    carfield_reg2hw_security_island_clk_div_value_reg_t security_island_clk_div_value; // [393:369]
    carfield_reg2hw_pulp_cluster_clk_div_value_reg_t pulp_cluster_clk_div_value; // [368:344]
    carfield_reg2hw_spatz_cluster_clk_div_value_reg_t spatz_cluster_clk_div_value; // [343:319]
    carfield_reg2hw_l2_clk_div_value_reg_t l2_clk_div_value; // [318:294]
    carfield_reg2hw_host_fetch_enable_reg_t host_fetch_enable; // [293:293]
    carfield_reg2hw_safety_island_fetch_enable_reg_t safety_island_fetch_enable; // [292:292]
    carfield_reg2hw_security_island_fetch_enable_reg_t security_island_fetch_enable; // [291:291]
    carfield_reg2hw_pulp_cluster_boot_enable_reg_t pulp_cluster_boot_enable; // [290:290]
  ...
  parameter logic [BlockAw-1:0] CARFIELD_PULP_CLUSTER_BOOT_ENABLE_OFFSET = 8'h c4;
  parameter logic [BlockAw-1:0] CARFIELD_PULP_CLUSTER_FETCH_ENABLE_OFFSET = 8'h c8;
  parameter logic [BlockAw-1:0] CARFIELD_SPATZ_CLUSTER_FETCH_ENABLE_OFFSET = 8'h cc;
  parameter logic [BlockAw-1:0] CARFIELD_HOST_BOOT_ADDR_OFFSET = 8'h d0;
  parameter logic [BlockAw-1:0] CARFIELD_SAFETY_ISLAND_BOOT_ADDR_OFFSET = 8'h d4;
  parameter logic [BlockAw-1:0] CARFIELD_SECURITY_ISLAND_BOOT_ADDR_OFFSET = 8'h d8;
  parameter logic [BlockAw-1:0] CARFIELD_PULP_CLUSTER_BOOT_ADDR_OFFSET = 8'h dc;
  parameter logic [BlockAw-1:0] CARFIELD_SPATZ_CLUSTER_BOOT_ADDR_OFFSET = 8'h e0;
  parameter logic [BlockAw-1:0] CARFIELD_L2_SRAM_CONFIG0_OFFSET = 8'h e4;
  parameter logic [BlockAw-1:0] CARFIELD_L2_SRAM_CONFIG1_OFFSET = 8'h e8;
  parameter logic [BlockAw-1:0] CARFIELD_L2_SRAM_CONFIG2_OFFSET = 8'h ec;
  parameter logic [BlockAw-1:0] CARFIELD_L2_SRAM_CONFIG3_OFFSET = 8'h f0;
  ...
  parameter logic [3:0] CARFIELD_PERMIT [61] = '{
    ...
    4'b 0001, // index[49] CARFIELD_PULP_CLUSTER_BOOT_ENABLE
    4'b 0001, // index[50] CARFIELD_PULP_CLUSTER_FETCH_ENABLE
    4'b 0001, // index[51] CARFIELD_SPATZ_CLUSTER_FETCH_ENABLE
    4'b 1111, // index[52] CARFIELD_HOST_BOOT_ADDR
    4'b 1111, // index[53] CARFIELD_SAFETY_ISLAND_BOOT_ADDR
    4'b 1111, // index[54] CARFIELD_SECURITY_ISLAND_BOOT_ADDR
    4'b 1111, // index[55] CARFIELD_PULP_CLUSTER_BOOT_ADDR
    4'b 1111, // index[56] CARFIELD_SPATZ_CLUSTER_BOOT_ADDR
    4'b 1111, // index[57] CARFIELD_L2_SRAM_CONFIG0
    4'b 1111, // index[58] CARFIELD_L2_SRAM_CONFIG1
    4'b 1111, // index[59] CARFIELD_L2_SRAM_CONFIG2
    4'b 1111  // index[60] CARFIELD_L2_SRAM_CONFIG3
  };
