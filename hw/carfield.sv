...
if (CarfieldIslandsCfg.pulp.enable) begin : gen_pulp_cluster
  ...
  localparam pulp_cluster_package::pulp_cluster_cfg_t IntegerClusterCfg = '{
    ...
    EnableReducedTag: 1,
    L2Size: L2MemSize,
    DmBaseAddr: IntClusterDbgStart,
    BootRomBaseAddr: IntClusterBootAddr,
    BootAddr: IntClusterBootAddr,
    EnablePrivateFpu: 1,
    EnablePrivateFpDivSqrt: 0,
    NumAxiIn: 4,
    NumAxiOut: 3,
    AxiIdInWidth: AxiSlvIdWidth, // 6
    AxiIdOutWidth: Cfg.AxiMstIdWidth, // 2
    AxiAddrWidth: Cfg.AddrWidth,
    ...
    SyncStages: SyncStages,
    ClusterBaseAddr: CarfieldIslandsCfg.pulp.base,
