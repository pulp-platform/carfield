...
vsim -c $TESTBENCH -t 1ps -voptargs=+acc +BINARY=$BINARY +BOOTMODE=$BOOTMODE +TESTMODE=$TESTMODE -permissive -suppress 3009 -suppress 2685 -suppress 2718 -suppress 8386 -suppress 8315 -suppress 8360
